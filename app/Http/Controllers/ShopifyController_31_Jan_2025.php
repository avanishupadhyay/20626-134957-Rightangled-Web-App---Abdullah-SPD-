...
class ShopifyController extends Controller
{
        ...
        */
        ...
        switch ($event) {
            ...
            case 'products/update':
                $this->handleProductsUpdate($payload);
                break;
    ...
    */
    ...
    public function getAmount($amount){
        if($this->storeDomain == '670fd5-2.myshopify.com'){
            return $amount * 12;
        }else{
            return $amount;
        }
    ...
    public function getUserDiscounts(Request $request){
        ...
        $params['amount']   = $this->getAmount($amount);
        ...
        try{
            ...
            if(empty($loyality) && $loyality->status != 'pending'){
                ...
                */
                ...
                $params['amount']   = $this->getAmount($payload['total_line_items_price']);
                ...
                if(isset($ct_response['success']) && $ct_response['success'] == 1){
                    ...
                    $order->total_amount            = $payload['total_line_items_price'];
                    ...
                    $loyality->order_amount            = $payload['total_line_items_price'];
    ...
    public function anonymousTransaction($payload) {
        ...
        */
        ...
        try{
            ...
            $orderObj->total_amount  = $payload['total_line_items_price'];
